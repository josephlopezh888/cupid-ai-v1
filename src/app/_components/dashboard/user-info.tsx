...
function HeaderButton({ email = ""}) {
    ...
    return (
        <div onClick={toggleDiv} className='w-[50px] h-[50px] rounded-full border-[1.5px] border-solid border-[#0F0F0F] cursor-pointer flex justify-center items-center'>
            <Image
                src={`/api/image/profile/${session?.user.email || ""}`}
                width={41}
                height={41}
                alt='logo' className='rounded-full'
            />
            {showDiv && (
                <><div className="absolute right-0 z-10 mt-[360px] mr-[25px] w-[270px] origin-top-right divide-y divide-[#303030] rounded-lg bg-[#0F0F0F] shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex={-1}>
                    <div className="py-3" role="none">
                        <h1 className='text-[16px] ml-[15px]'>Signed in as</h1>
                        <h1 className='text-[15px] ml-[15px] text-gray-400'>{email}</h1>
                    </div>
                    <div className="py-1" role="none">
                        <div className="px-5 flex items-center w-full hover:bg-[#1c1c1c]">
                            <svg className="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true" viewBox="0 0 20 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a href="#" className="text-gray-200 block px-3 py-3 text-[15px]" role="menuitem" tabIndex={-1} id="menu-item-0">Account Settings</a>

                        </div>
                        <div className='px-5 flex items-center w-full hover:bg-[#1c1c1c]'>
                            <svg className="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                            ...
                            <a href="#" className="text-gray-200 block px-4 py-3  text-[15px]" role="menuitem" tabIndex={-1} id="menu-item-0">Team</a>
                        </div>
                        <div className='px-5 flex items-center w-full hover:bg-[#1c1c1c]'>
                        <svg className="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12.079 4.839a3 3 0 0 0-4.255.1M11 18h1.083A3.916 3.916 0 0 0 16 14.083V7A6 6 0 1 0 4 7v7m7 4v-1a1 1 0 0 0-1-1H9a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1Zm-7-4V8H3a2 2 0 0 0-2 2v2a2 2 0 0 0 2 2h1Zm12-6h1a2 2 0 0 1 2 2v2a2 2 0 0 1-2 2h-1V8Z"/>
                        ...
                        <a href="#" className="text-gray-200 block px-4 py-3 text-[15px]" role="menuitem" tabIndex={-1} id="menu-item-1">Support</a>
                        </div>
                    </div>
                    <div className="py-1" role="none">
                        <div className='px-5 flex items-center w-full hover:bg-[#1c1c1c]'>
                        <svg className="w-[25px] h-[25px] text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 18 15">
    <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M1 7.5h11m0 0L8 3.786M12 7.5l-4 3.714M12 1h3c.53 0 1.04.196 1.414.544.375.348.586.82.586 1.313v9.286c0 .492-.21.965-.586 1.313A2.081 2.081 0 0 1 15 14h-3"/>
                        ...
                        <a href="#" className="text-gray-200 block px-4 py-3 text-[15px]" role="menuitem" tabIndex={-1} id="menu-item-6" onClick={() => signOut()}>Sign Out</a>
                        </div>
                    </div>
                </div>
                </>
